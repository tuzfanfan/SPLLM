...
当用户说“按卡兹克的风格写”“更像真人一点”“这段AI味太重了”时，先参考下面的正反例，不要只停留在抽象规则。

**样本使用原则**：
- 先判断当前段落最像哪类反例，再按对应正例修
- 学的是视角、节奏、落点，不是逐字复刻
- 一次只引用 1-2 个最贴近当前任务的样本，避免风格过载
...
为什么有些东西，你明明天天看，明明就在眼前，可它真的变了，你却总要过很久才反应过来。

AI这波也是。

它不是突然有一天闯进来的。

是我们一边觉得它还早，一边已经开始被它重新安排工作、重新安排注意力，甚至重新安排焦虑了。
```

这个正例为什么有效：
- 先从作者脑中的一个小问题切入，不是空降观点
- 一步步推进，最后才落到主题
- 有私人感受，也有时代感
...
```text
近年来，人工智能技术快速发展，正在深刻改变社会生产和个人生活方式。面对这一趋势，我们有必要重新思考人与技术之间的关系。
```
...
但你真把它拆开了，会发现很多事其实没有想象中那么玄。
```

这个正例为什么有效：
- 有鲜明判断，但先承认普通人的真实处境
- 用具体术语把压力感写出来
- 没有教育口气，是“我理解你，然后我陪你拆开”

**反例 2：导师式输出**

```text
如果你还没有掌握AI相关能力，那你现在必须尽快行动，否则很快就会被时代淘汰。
```
...
可能是刚毕业，在出租屋里投简历投到半夜两点的年轻人。也可能是在公司待了七八年，突然发现自己那套经验开始不值钱的人。

数字本身不会让你难受。

但你一想到它最后会落到谁身上，那种感觉就完全不一样了。
```
...
```text
根据相关统计数据，当前就业市场竞争激烈，岗位要求提高，人才供需关系正在发生变化，这一趋势值得所有人关注。
```

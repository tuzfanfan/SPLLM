...
一个基于Obsidian构建的、与LLM深度集成的个人知识管理系统，支持书籍蒸馏、概念提取、技能生成和AI辅助创作。

---

## 🎯 项目愿景

将零散的学习资料转化为结构化的知识资产，通过AI辅助实现：
...
│
├── 📖 books/                   # 书籍蒸馏产物
│   └── mao-xuanji/            # 毛泽东选集技能化（10个技能）
│
├── 📰 daily-feed/              # 每日市场信息（15个AI工具手册）
├── 📎 raw/                     # 原始素材（82个品牌营销文档）
├── 📄 CLAUDE.md                # Agent操作指南 v1.8
...
| 类型 | 数量 | 用途 | 示例 |
|------|------|------|------|
| **Sources** | 2,791 | 来源摘要 | 书籍摘要、文章摘录 |
| **Concepts** | 1,240 | 抽象概念 | "心理学"、"投资"、"持久战" |
| **Entities** | 1,244 | 具体实体 | "马云"、"苹果公司"、"脑白金" |

**关联方式**：
- 双向链接：`[[概念名]]`
- 网盘关联：每个source包含 `webdav_url` 指向夸克网盘原始文件
...
- **GitHub仓库**：https://github.com/tuzfanfan/SPLLM
- **CLAUDE.md**：Agent操作指南
- **AGENTS.md**：工作流程说明
- **SCHEMA.md**：完整规范文档
...
### 2026-05-15
- Wiki健康度清理：删除1,591个空壳/重复/乱码页面
- 网盘资源整合：3,236个文件添加webdav_url
- CLAUDE.md更新至v1.8
